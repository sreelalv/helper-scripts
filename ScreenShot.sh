...
shotarea() {
  ...
  # Copy with saving
    ...
    f_name="$(zenity --entry)"
    if [[ $? == 0 ]] ; then 
		while [[ $(ls /home/sree/Pictures/Screenshots/ | grep -i -E  "^${f_name}.png$") ]] 
		do 
